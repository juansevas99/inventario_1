<?php
class tipo_activo extends Controller{
    function __construct()
    {
        parent::__construct("tipo_activo_m");
       
    }
    function visualizartipo_activo(){
        $this->title="Administracion de tipos de activo";
        $clase="tipo_activo";
        $metodoActualizar="actualizarTipo_activo";
        $filtros="";
        if (isset($_POST['send'])){
            unset($_POST['send']);
            $filtros=$_POST;
